...
export default function AuthSimpleLayout({ children, title, description }: PropsWithChildren<AuthLayoutProps>) {
    return (
        <div className="flex h-screen flex-col items-center justify-center gap-6 bg-[url(/public/background.jpeg)] p-6 md:p-10">
            <div className="w-130 max-md:w-100 md:max-xl:w-150">
