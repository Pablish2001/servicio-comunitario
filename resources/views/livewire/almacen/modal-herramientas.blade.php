            ...
            <div class="p-4 border-t">
                ...
                <div class="flex flex-wrap items-end gap-2 mb-4">
                    <div class="w-32">
                        ...
                        >
                            ...
                            <option value="quirurgica">quirúrgico</option>
                ...
                <div wire:loading.remove wire:target="unidad,presentacion,estado">
                    ...
                    @if($itemsFiltrados->isEmpty())
                        <p class="text-gray-500">No hay registros para esta herramienta con los filtros actuales.</p>
                        @else
                                    ...
                                    @foreach($itemsFiltrados as $med)
                                        <tr class="border-t" wire:key="med-{{ $med->id }}">
                                            ...
                                            <td class="px-4 py-2 text-center">
                                                ...
                                                title="Puedes editar la cantidad de la herramienta">
                                            </td>
                                            <td class="px-4 py-2 text-center">{{ $med->categoria }}</td>
